...
const EditUserModal = ({ isOpen, onClose, onUserUpdated, user, existingEmails }) => {
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md bg-surface-card border border-navy-700/50 rounded-xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
        >
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-navy-700/50 sticky top-0 bg-surface-card z-10">
            <div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {/* User ID Display */}
            <div className="p-3 bg-navy-800/30 border border-navy-700/50 rounded-lg">
              <p className="text-xs text-gray-400">User ID</p>
              <p className="text-sm font-mono text-white mt-1">{user.id}</p>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-navy-800/30 border border-navy-700/50 rounded-lg">
              <input
                type="checkbox"
                id="changePassword"
                ...
                className="w-4 h-4 text-info bg-navy-800 border-navy-700 rounded focus:ring-info focus:ring-2"
              />
              <label htmlFor="changePassword" className="text-sm text-gray-300 cursor-pointer">
                Change Password
              </label>
            </div>
